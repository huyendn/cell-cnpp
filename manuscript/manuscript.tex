...
This allows, for example, the use of an Anderson–Darling test to assess the validity of the
constant-rate assumption. We performed this test for the two data sets analyzed in Section~\ref{application}
and found that the assumption of constant $r$ is supported by the data.
